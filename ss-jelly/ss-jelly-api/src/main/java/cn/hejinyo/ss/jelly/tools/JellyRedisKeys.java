...
import cn.hejinyo.ss.jelly.consts.JellyConstant;
...
public class JellyRedisKeys {
    ...
    public static final String USER_CUR_DEPT = JellyConstant.Dept.CUR_DEPT.getValue();
    public static final String USER_SUB_DEPT = JellyConstant.Dept.SUB_DEPT.getValue();
    public static final String USER_ALL_DEPT = JellyConstant.Dept.ALL_DEPT.getValue();
